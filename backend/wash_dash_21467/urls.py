"""wash_dash_21467 URL Configuration
...
admin.site.site_header = "Wash Dash"
admin.site.site_title = "Wash Dash Admin Portal"
admin.site.index_title = "Wash Dash Admin"

# swagger
api_info = openapi.Info(
    title="Wash Dash API",
    default_version="v1",
    description="API documentation for Wash Dash App",
)
